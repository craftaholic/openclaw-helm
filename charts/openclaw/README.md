...
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.4.61-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"151.0.7922.34"` | Chromium sidecar image version |
