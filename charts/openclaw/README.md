...
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.4.58-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"150.0.7871.115"` | Chromium sidecar image version |
