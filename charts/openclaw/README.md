...
[![App Version](https://img.shields.io/badge/App_Version-2026.6.11-blue)](https://github.com/openclaw/openclaw)
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.4.57-blue)](https://github.com/serhanekicii/openclaw-helm)
...
|-----|------|---------|-------------|
| app-template.chromiumVersion | string | `"150.0.7871.101"` | Chromium sidecar image version |
